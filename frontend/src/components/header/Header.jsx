    ...
    <>
      <div className="header">
        {car && (
          <>
            <img
              className="green-background-image"
            ...
            />
            <img
              className="transparent-background-image"
        ...
        <img
          src={CarYellowCircle}
          alt="Yellow Circle"
          className={`yellow-circle ${active && "active"}`}
        />
        <header>
          <Link to={"/"}>
        ...
        {car && (
          <div className="choose-car-and-travel">
            ...
            <div
              className="choose-car-and-travel--car"
              onMouseEnter={() => setActive(true)}
              onMouseLeave={() => setActive(false)}
            >
              <img
                src={CarCircle}
                className={"first-car-circle"}
                alt="Moving Circle"
              />
              <img
                src={CarGreenBackground}
                className={"car-green-background"}
                alt="car green background"
              />
